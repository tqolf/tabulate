...
int main()
{
    ...
    if (getarg(false, "--times", "--freq", "--bitset", "--aes")) {
    ...
    if (getarg(false, "--aes")) {
        ...
        bool use_clone = getarg(false, "--use-clone");
