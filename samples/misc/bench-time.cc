...
int main(int argc, char **argv)
{
            ...
            if (n != expected) {
                ...
                for (auto r : ranges) {
                    for (size_t i = r.min * 2 / 3; i < r.max * 3 / 2; i++) {
                        if (set.test(i)) {
                            if (i < r.min || i >= r.max) {
                                std::cout << __LINE__ << " Unexpected(yes): " << i << std::endl;
                            }
                        } else {
                            if (i >= r.min && i < r.max) {
                                std::cout << __LINE__ << " Unexpected(no): " << i << std::endl;
                            }
                        }
                    }
                }
...

    {
        ...
        profiler::Add("roaring::bitmap::contains", [&]() {
            ...
            for (size_t i = min * 2 / 3; i < max * 3 / 2; i++) {
                n += roaring_bitmap_contains(bitmap, i);
            }
        ...
        profiler::Add(
            ...
            [&]() {
                ...
                if (n != expected) {
                    ...
                    for (auto r : ranges) {
                        for (size_t i = r.min * 2 / 3; i < r.max * 3 / 2; i++) {
                            if (set.test(i) == lockfree::status::yes) {
                                if (i < r.min || i >= r.max) {
                                    std::cout << __LINE__ << " Unexpected(yes): " << i << std::endl;
                                }
                            } else {
