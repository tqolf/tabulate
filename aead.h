...
class AEAD_WITH_EVP {
  public:
    AEAD_WITH_EVP(const AEAD_WITH_EVP &another) = delete;
    AEAD_WITH_EVP(AEAD_WITH_EVP &&another) = delete;
    AEAD_WITH_EVP &operator=(const AEAD_WITH_EVP &another) = delete;
    AEAD_WITH_EVP &operator=(AEAD_WITH_EVP &&another) = delete;
