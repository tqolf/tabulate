...
class IniTempl {
  public:
    struct Entry {
        ...
        Entry(const Character *item, const Character *comment, int order)
            : item(item), comment(comment), order(order)
        {
        }
  ...
  public:
    ...
    const Character *GetValue(const Character *a_pSection, const Character *a_pKey,
                              const Character *a_pDefault = NULL, bool *a_pHasMultiple = NULL) const;
    ...
    int SetLongValue(const Character *a_pSection, const Character *a_pKey, long a_nValue,
                     const Character *a_pComment = NULL, bool a_bUseHex = false,
...
template <class Character, class Compare, class Encoder>
IniTempl<Character, Compare, Encoder>::IniTempl(bool use_utf8, bool a_bAllowMultiKey,
...
template <class Character, class Compare, class Encoder>
const Character *IniTempl<Character, Compare, Encoder>::GetValue(const Character *a_pSection,
                                                                 const Character *a_pKey,
...
template <class Character, class Compare, class Encoder>
long IniTempl<Character, Compare, Encoder>::GetLongValue(const Character *a_pSection,
                                                         const Character *a_pKey, long a_nDefault,
                                                         bool *a_pHasMultiple) const
{
...
template <class Character, class Compare, class Encoder>
int IniTempl<Character, Compare, Encoder>::SetLongValue(const Character *a_pSection,
                                                        const Character *a_pKey, long a_nValue,
                                                        const Character *a_pComment, bool a_bUseHex,
...
template <class Character, class Compare, class Encoder>
double IniTempl<Character, Compare, Encoder>::GetDoubleValue(const Character *a_pSection,
                                                             const Character *a_pKey, double a_nDefault,
                                                             bool *a_pHasMultiple) const
{
    // return the default if we don't have a value
    const Character *pszValue = GetValue(a_pSection, a_pKey, NULL, a_pHasMultiple);
...
template <class Character, class Compare, class Encoder>
int IniTempl<Character, Compare, Encoder>::SetDoubleValue(const Character *a_pSection,
                                                          const Character *a_pKey, double a_nValue,
                                                          const Character *a_pComment, bool a_bForceReplace)
{
    // use SetValue to create sections
    if (!a_pSection || !a_pKey) return SI_FAIL;
...
template <class Character, class Compare, class Encoder>
bool IniTempl<Character, Compare, Encoder>::GetBoolValue(const Character *a_pSection,
                                                         const Character *a_pKey, bool a_bDefault,
                                                         bool *a_pHasMultiple) const
{
    // return the default if we don't have a value
    const Character *pszValue = GetValue(a_pSection, a_pKey, NULL, a_pHasMultiple);
...
template <class Character, class Compare, class Encoder>
int IniTempl<Character, Compare, Encoder>::SetBoolValue(const Character *a_pSection,
                                                        const Character *a_pKey, bool a_bValue,
                                                        const Character *a_pComment, bool a_bForceReplace)
{
    // use SetValue to create sections
    if (!a_pSection || !a_pKey) return SI_FAIL;
...
template <class Character, class Compare, class Encoder>
bool IniTempl<Character, Compare, Encoder>::GetAllValues(const Character *a_pSection,
                                                         const Character *a_pKey, Entries &a_values) const
{
    a_values.clear();
...
template <class Character, class Compare, class Encoder>
const typename IniTempl<Character, Compare, Encoder>::Pairs *IniTempl<
    Character, Compare, Encoder>::GetSection(const Character *a_pSection) const
{
    if (a_pSection) {
...
int IniTempl<Character, Compare, Encoder>::Save(Writer &a_oOutput, bool a_bAddSignature) const
{
    ...
    for (; iSection != oSections.end(); ++iSection) {
        ...
        if (iSection->comment) {
            ...
            if (!OutputMultiLineText(a_oOutput, convert, iSection->comment)) {
                return SI_FAIL;
            }
            bNeedNewLine = false;
        }
        ...
        for (; iKey != oKeys.end(); ++iKey) {
            ...
            for (; iValue != oValues.end(); ++iValue) {
                ...
                if (iValue->comment) {
                    a_oOutput.Write(SI_NEWLINE);
                    if (!OutputMultiLineText(a_oOutput, convert, iValue->comment)) {
                        return SI_FAIL;
                    }
                }
...
template <class Character, class Compare, class Encoder>
bool IniTempl<Character, Compare, Encoder>::DeleteValue(const Character *a_pSection,
                                                        const Character *a_pKey, const Character *a_pValue,
                                                        bool a_bRemoveEmpty)
{
    if (!a_pSection) {
        return false;
